      ...
      <section className="mint-section">
        <div className="container">
          <div className="row">
            ...
            <div className="col-12 col-md-5 mint-it-col ps-5">
                  ...
                  <>
                    ...
                    <nav className="nav-tabs-col">
                      <div className="nav nav-tabs" id="nav-tab" role="tablist">
                        <button className="nav-link active" onClick={onSaleHandler} id="nav-profile-tab1" data-bs-toggle="tab" data-bs-target="#nav-tabContent1" type="button" role="tab" aria-controls="nav-tabContent1" aria-selected="true">
